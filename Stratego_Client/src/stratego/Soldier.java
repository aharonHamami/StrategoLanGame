    ...
    private void kill(Soldier enemy) { // בודק מי חזק יותר והורג את המיותר
        if(enemy.getRank() == 0){
            if(enemy.isFriend()){
                ...
                System.out.println("i did it green");
                System.out.println("i did it in "+enemy.getPlace()[0]+","+enemy.getPlace()[1]+" and his level is "+enemy.getRank());
            }
            board.stopGame();
            return;
        }
        if(this.level == 1 && enemy.getRank() == 10 || this.level == 3 && enemy.getRank() == 11){ // למקרים מיוחדים
            ...
            if(this.isFriend()) System.out.println("you win");
            ...
            if(this.isFriend()) System.out.println("you lose");
