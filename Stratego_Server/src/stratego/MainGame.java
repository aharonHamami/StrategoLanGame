/* הוראות:
את המשחק מפעילים באמצעות הפעלה בכל תכנית את המחלקה
MainGame

כדי לקצר תהליכים שמתי במחלקות של הרשת בשורות ארבעים וארבעים ואחת שתי שורות קוד
אחת מסדרת אוטומטית את החיילים
אחת לא מסדרת אוטומטית ונותנת לך לסדר ידנית

את ה
IP
מחקתי.
אז רק צריך להוסיף את זה לקוד בתכנית של הלקוח
*/
package stratego;
...
public class MainGame extends javax.swing.JFrame {
    ...
    private ServerClass client;
    
    // משתנים משניים
    private boolean heIsReady; // מצג אם השחקן השני כבר מוכן לשחק
    private boolean iAmReady; // מציג אם השחקן שלי מוכן לשחק
    ...
    private void init() {
        ...
        JPanel infoPanel1 = new JPanel();             // לוח אדום שמאלי להרוגים שלהם
        ...
        for(int i=0; i<11; i++){
            ...
            infoButtons1[i][0].setContentAreaFilled(false); // שלוש שורות קוד לרקע שקוף לכפתורים
            ...
            infoButtons1[i][1].setContentAreaFilled(false); // שלוש שורות קוד לרקע שקוף לכפתורים
        ...
        JPanel infoPanel2 = new JPanel();            // לוח כחול ימני להרוגים שלנו
        ...
        IpDialog.add(new JPanel().add(new JLabel("IP address is: ")));
        IpDialog.setLocation(this.getX()+this.getWidth()/2 - IpDialog.getWidth()/2, this.getY()+this.getHeight()/2);
